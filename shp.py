...
#st.write(gdf1) 
st.write(gdf2) 
st.write("S_1 et S_2: rongeurs susceptibles à sensibilité differente ")
st.write("I_1 et I_2: rongeurs infectés respecivement issus de S_1 et S_2 ")
st.write("A_1 et A_2: puces vivants respectivement sur les rats S_1 et S_2")
st.write("L_1 et L_2: Puces libres infectueuses respectivement classées pour les rats S_1 et S_2")
